...
const TextFieldWithIcon = ({ id, label, labelColor, children, onIconClick, required, inputClassName = '', maxlength, widthInput }: TextFieldWithIconProps) => {
  ...
  return (
    <div className="d-md-flex justify-content-center align-items-center">
      ...
      <div style={containerStyle}>
        <input type="text" maxLength={maxlength} className={"flex-grow-1 h-100 input-text-icon " + inputClassName} id={id} style={inputStyle} required={required} onInvalid={() => setErrorAction(true)} onInput={() => setErrorAction(false)} />
