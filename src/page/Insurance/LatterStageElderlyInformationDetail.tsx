...
function LatterStageElderlyInformationDetail() {
  ...
  const handleEdit = () => {
    navigate('/user/insurance/latter-stage-elderly/update');
  };
            ...
            <div>
              ...
              >
                ...
                <Col sm={8} className="mt-2-div mt-2">
                  <Form.Label>令03/10/01</Form.Label>
                </Col>
              </Form.Group>
              ...
              >
                ...
                <Col sm={8} className="mt-2-div mt-2">
                  <Form.Label>39131024</Form.Label>
                </Col>
              </Form.Group>
              ...
              >
                ...
                <Col sm={8} className="mt-2-div mt-2">
                  <Form.Label> 東京都後期高齢者医療広域連合</Form.Label>
                </Col>
              </Form.Group>
              ...
              >
                ...
                <Col sm={8} className="mt-2-div mt-2">
                  <Form.Label>391000111111111</Form.Label>
                </Col>
              </Form.Group>
              ...
              >
                ...
                <Col sm={8} className="mt-2-div mt-2">
                  <Form.Label>令03/01月　15,000円</Form.Label>
                </Col>
              </Form.Group>
            </div>
...
export default LatterStageElderlyInformationDetail;
