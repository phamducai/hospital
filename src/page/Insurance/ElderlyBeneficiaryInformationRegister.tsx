...
function ElderlyBeneficiaryInformationRegister() {
  ...
  // Close Button
  const handleOnClose = () => {
    navigate('/user/insurance/elderly-beneficiary');
  };
          ...
          <Form.Group className="user-detail d-flex flex-column">
            ...
            >
              <Form.Label
                ...
                className="bg-light-yellow label-dialog"
              >
                一部負担金の割合<span className="color-text-custom">【必】</span>
              </Form.Label>
              <Col sm={8}>
                <Form.Select name="record_date" defaultValue={co_payment_ratio} required>
...
export default ElderlyBeneficiaryInformationRegister;
