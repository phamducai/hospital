...
function LimitCertificationInformationUpdate() {
...
const handleOnClose = () => {
    navigate('/user/insurance/limit-identification/0');
  }
  ...
  return (
    <MasterLayout userInfo={tableSelectedItem}>
      <div className="main">
        {/* Page limit certification info update*/}
        <Form
          ref={refUserDialog}
          noValidate
          validated={validated}
              ...
              >
                ...
                <Col sm={8}>
                  <Form.Select
                    ...
                    defaultValue={applicable_distinction[15]}
                    required
                  >
                    {applicable_distinction.map((applicable_distinction, index) => (
...
export default LimitCertificationInformationUpdate;
