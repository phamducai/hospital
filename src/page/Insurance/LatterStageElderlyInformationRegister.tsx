...
/**
 * PG ID: LatterStageElderlyInformationRegister
 * PG NAME: 後期高齢者情報 (Latter Stage Elderly Information Register)
 */
...
function LatterStageElderlyInformationRegister() {
  ...
  // Close Button
  const handleOnClose = () => {
    navigate('/user/insurance/latter-stage-elderly');
  };
          ...
          <Form.Group className="user-detail d-flex flex-column">
                  ...
                  <div className="d-md-flex justify-content-start align-items-center mt-2 mt-md-0">
                    <div className="d-flex justify-content-start align-items-center">
                      <Form.Control
                        ...
                        maxLength={3}
                      />
                      <Button className="ms-2">保険者検索</Button>
                    </div>
                    <div className="fz-12 text-end ps-xs-0 ps-sm-1">
                      ＜半角数字＞
                    </div>
                ...
                <Row>
                  <div className="d-md-flex justify-content-start align-items-center mt-2 mt-md-0">
                    <Form.Control
                      type="text"
                      required
                      defaultValue={targetRow.person_symbol}
                      name="person_symbol"
                      readOnly={showOnly}
                      onChange={(e) => handleOnChangeValue(e)}
            ...
            >
              <Form.Label
                ...
                className="bg-light-yellow label-dialog"
              >
                一部負担金の割合<span className="color-text-custom"></span>
                <span className="color-text-custom">【必】</span>
              </Form.Label>
              <Col sm={8}>
                <Form.Select
                  ...
                  <div className="d-md-flex justify-content-start align-items-center mt-2 mt-md-0">
                    <div className="d-flex justify-content-start align-items-center">
                      <Form.Control
                        ...
                        maxLength={3}
                      />
                      <div className="fz-12 ps-xs-0 ps-sm-1 ms-2 min-width-25 me-0">円</div>
                    </div>
                  </div>
                </Row>
              </Col>
...
export default LatterStageElderlyInformationRegister;
