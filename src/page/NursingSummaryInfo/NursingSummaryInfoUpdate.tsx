...
/**
 * PG ID: NursingSummaryInfoUpdate (Nursing summary information)
...
function NursingSummaryInfoUpdate() {
  ...
  const handleOnClose = () => {
    navigate('/nurse/nursing-summary-info');
  };
        ...
        <div className="px-1 px-md-3 w-100 my-2">
          ...
          <Form className="w-100 h-100 d-flex flex-column" id="nursing-info">
            <Form.Group className="input-detail user-detail d-flex flex-column">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              ...
                              <Form.Check name="assistant_nurse" label="ＨＢｓ" className="ms-4" checked/>
                    ...
                    <Table responsive className='table-bordered mb-2'>
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="無" className="ms-4" checked/>
                      ...
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            ...
                            <Form.Control
                              ...
                              style={{ height: '100px' }}
                              defaultValue='炎症をおこしている。入院治療が必要。'
                            />
                            </Col>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <Form.Control
                            ...
                            name="health_and_welfare"
                            style={{ height: '100px' }}
                            defaultValue='炎症の度合いが悪いようである。できれば入院による治療を行いたい。'
                          />
                          </Col>
                          </td>
                        </tr>
                      ...
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="無" className="ms-4"/>
                              <Form.Check name="nurse" label="有" className="ms-4" checked/>
                            </div>
                          </td>
                        </tr>
                        <tr>
                      ...
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr>
                          ...
                          <Form.Control
                            ...
                            name="health_and_welfare"
                            style={{ height: '100px' }}
                            defaultValue='平成２６年３月３１日リハビリセンターを退院する。入院中から、褥瘡や膀胱&#10;炎等がみられており、退院後の在宅生活フォローの&#10;ため訪問看護導入となる。'
                          />
                          </Col>
                          </td>
                        </tr>
                      ...
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr>
                          ...
                          <Form.Control
                            ...
                            name="health_and_welfare"
                            style={{ height: '100px' }}
                            defaultValue='＃1：運動がコントロールできないことによる身体損傷リスク&#10;＃2：胸郭の変形、咳反射が弱いことに関連した非効果的呼吸パターン&#10;＃3：胸やけなどの消化器症状があることでの安楽障害'
                          />
                          </Col>
                          </td>
                        </tr>
              ...
              <div className='form-group-container my-4 pb-0 mt-4'>＜日常生活動作（ＡＤＬ）等の状況＞</div>
                    ...
                    <Table responsive className='table-bordered mb-2'>
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="普通食" className="ms-4" checked/>
                            ...
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="経管栄養" className="ms-4" checked/>
                            </div>
                          </td>
                        </tr>
                        <tr>
                    ...
                    <Table responsive className='table-bordered mb-2'>
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="自立" className="ms-4" checked/>
                    ...
                    <Table responsive className='table-bordered mb-2'>
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="トイレ" className="ms-4" checked/>
                              <Form.Check name="nurse" label="ポータブルトイレ" className="ms-4" />
                              <Form.Check name="assistant_nurse" label="おむつ" className="ms-4"/>
                            </div>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="尿器" className="ms-4" checked/>
                      ...
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            ...
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="その他" className="ms-4" checked/>
                            </div>
                          </td>
                        </tr>
                        <tr>
                    ...
                    <Table responsive className='table-bordered mb-2'>
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="入浴" className="ms-4" checked/>
                        ...
                        <tr >
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              ...
                              <Form.Check name="assistant_nurse" label="右側" className="ms-2" checked/>
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              ...
                              <Form.Check name="nurse" label="杖" className="ms-4" checked/>
                    ...
                    <Table responsive className='table-bordered mb-2'>
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="清明" className="ms-4" checked/>
                    ...
                    <Table responsive className='table-bordered mb-2'>
                      <tbody className="bg-light-yellow label-dialog">
                        ...
                        <tr >
                          ...
                          <td className='bg-white'>
                            <div className="d-flex justify-content-start align-items-center ms-md-3  mt-2 mt-md-2 align-middle">
                              <Form.Check name="health_nurse" label="問題なし" className="ms-4" checked/>
...
export default NursingSummaryInfoUpdate;
