  ...
  const handleEdit = (mode: any) => {
    switch (mode) {
      case 1:
        ...
        break;
      case 2:
        navigate('/user/detail/nursing-basic-info/update-2');
        break;
      case 3:
        navigate('/user/detail/nursing-basic-info/update-3');
        break;
      case 4:
        navigate('/user/detail/nursing-basic-info/update-4');
        break;
      default:
        break;
    }
